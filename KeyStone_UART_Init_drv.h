...
typedef enum{
	ONE_STOP_BIT = (0x00000000u),
	WLS_STOP_BIT = CSL_UART_LCR_STB_WLS
}UART_stopMode;

typedef enum{
	
	DATA_LEN_5BIT = (0x00000000u),
	DATA_LEN_6BIT = (0x00000001u),
	DATA_LEN_7BIT = (0x00000002u),
	DATA_LEN_8BIT = (0x00000003u)
}UART_dataLength;
...
typedef enum{
	OVER_SAMPLING_16X = (0x00000000u),
	OVER_SAMPLING_13X = (0x00000001u)
}UART_overSampling;
...
extern void KeyStone_UART_config(Uint32 baudRate, Bool bLoopBackEnable,
